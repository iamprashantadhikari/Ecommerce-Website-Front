                ...
                <div className="container flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center gap-4">
                        <div className="relative group flex items-center justify-end">
                            <input
                                type="text"
                                placeholder="Search here" className="w-[200px] sm:w-[200px]
                            ...
                            />
                            <IoMdSearch className="text-gray-500 group-hover:text-primary absolute right-3"
                            />
                        </div>
                     ...
                     <button
                     onClick={() => {alert('hello')}}
                     className="bg-gradient-to-r from-primary to-secondary text-white transition-all duration-200
                     py-1 px-4 rounded-full flex items-center gap-3 group"
                     >
                        <span className="group-hover:block hidden transistion-all duration-200">
                            Order
                        </span>
                        <FaCartShopping
