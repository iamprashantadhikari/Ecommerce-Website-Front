            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 item center gap-6">
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Non, quis libero maxime neque fuga rem harum in assumenda a nostrum fugit suscipit, aliquam, dolor temporibus consequuntur facilis eveniet beatae reiciendis?
                    </p>
